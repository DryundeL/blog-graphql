...
func (ec *executionContext) field_Mutation_CreatePost_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewPost2githubᚗcomᚋDryundeLᚋgraphqlᚋgraphᚋmodelᚐNewPost(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_UpdatePost_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalONewPost2ᚖgithubᚗcomᚋDryundeLᚋgraphqlᚋgraphᚋmodelᚐNewPost(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_CreatePost(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNPost2ᚖgithubᚗcomᚋDryundeLᚋgraphqlᚋgraphᚋmodelᚐPost(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_GetAllPosts(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Post)
	fc.Result = res
	return ec.marshalNPost2ᚕᚖgithubᚗcomᚋDryundeLᚋgraphqlᚋgraphᚋmodelᚐPostᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNNewPost2githubᚗcomᚋDryundeLᚋgraphqlᚋgraphᚋmodelᚐNewPost(ctx context.Context, v any) (model.NewPost, error) {
	res, err := ec.unmarshalInputNewPost(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNPost2githubᚗcomᚋDryundeLᚋgraphqlᚋgraphᚋmodelᚐPost(ctx context.Context, sel ast.SelectionSet, v model.Post) graphql.Marshaler {
	return ec._Post(ctx, sel, &v)
}

func (ec *executionContext) marshalNPost2ᚕᚖgithubᚗcomᚋDryundeLᚋgraphqlᚋgraphᚋmodelᚐPostᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Post) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNPost2ᚖgithubᚗcomᚋDryundeLᚋgraphqlᚋgraphᚋmodelᚐPost(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNPost2ᚖgithubᚗcomᚋDryundeLᚋgraphqlᚋgraphᚋmodelᚐPost(ctx context.Context, sel ast.SelectionSet, v *model.Post) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalONewPost2ᚖgithubᚗcomᚋDryundeLᚋgraphqlᚋgraphᚋmodelᚐNewPost(ctx context.Context, v any) (*model.NewPost, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalInputNewPost(ctx, v)
